...
mod tests {
    ...
    fn word_native_defaults_and_wasm_isolation_are_manifest_contracts() {
        ...
        for dependency in [
            "oxml-layout = { path = \"crates/oxml-layout\", version = \"0.8.0\", default-features = false }",
            "rdocx = { path = \"crates/rdocx\", version = \"0.11.0\", default-features = false }",
            "rdocx-layout = { path = \"crates/rdocx-layout\", version = \"0.11.0\", default-features = false }",
        ] {
            assert!(
