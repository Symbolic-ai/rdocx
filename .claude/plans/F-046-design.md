...
After F-X005 publishes `oxml-layout` and `oxml-pdf` 0.1.0, make
...
| packaging | affected archive dry-runs | Registry 0.1.0 dependencies resolve, required assets remain present, and archives stay below 10 MiB |
