...
| DOCX-013 | numbering | style-linked counters, restarts, TOC, and REF | Y | Y | Y | Y | Y | all | Y | Y | P | Y | B | B | B | partial | implementation:`crates/rdocx/src/document.rs`,implementation:`crates/rdocx-layout/src/style_resolver.rs`,implementation:`crates/rdocx/src/field.rs` | F-248 |
