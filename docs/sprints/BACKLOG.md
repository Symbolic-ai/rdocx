...
| M6, Shared publication and rdocx cutover     | 6  | 0 | 4 | 2  |
...
| F-047 | Packaging include and size gate              | S32.1 | M | in-progress |
| F-048 | Automate split-family release preparation   | S32.1 | M | in-progress |
| F-049 | Extend publish.yml to the extracted workspace| S32.1 | M | in-progress |
| F-050 | CI matrix additions                          | S32.1 | S | in-progress |
