...
| M6, Shared publication and rdocx cutover     | 6  | 4 | 2 | 0  |
...
| F-027 | rdocx adopts oxml-media                      | S32.2 | M | in-progress |
| F-028 | add_picture_auto                             | S32.2 | S | in-progress |
...
| F-ID | Title | Sprint | Size | Status |
|------|-------|--------|------|--------|
| F-046 | rdocx layout and PDF cutover                 | S32.2 | M | in-progress |
...
| F-051 | CHANGELOG and migration notes                | S32.2 | S | in-progress |
