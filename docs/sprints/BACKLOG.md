...
| X, Cross-cutting (opportunistic)            | 8  | 6 | 1 | 1  |
| **Total** | **162** | **160** | **1** | **1** |
...
| F-X007 | Integrate PR 25 and stable crate documentation | S38 | L | in-progress |
| F-X008 | Tag the updated stable rdocx family         | S38 | S | pending |
