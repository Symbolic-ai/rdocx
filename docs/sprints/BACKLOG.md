...
|-----------|-------|------|-------------|---------|
| M1, Preparation and safety net              | 12 | 6 | 5 | 1  |
...
| F-008 | Non-consuming setter twins                   | S02 | M | in-progress |
| F-009 | Cache the layout result                      | S02 | M | in-progress |
| F-010 | Reserve crate names                          | S02 | S | in-progress |
| F-011 | Pin unit truncation behaviour                | S02 | S | in-progress |
