...
- `docs/hld/14-development-backlog.md`, for the M16 end gate, the three field
  stories, the reader-compatibility correction, their dependencies, and their
...
F-203 independently corrects reader preservation found during upstream review.
...
- Foreign table properties and numbering-level raw XML retain their bytes and
  schema positions through a round trip.
