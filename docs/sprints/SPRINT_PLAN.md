...
F-X087 and F-X088 are user-approved scope exceptions that raise S71 from the
usual maximum of seven F-IDs to nine. F-X087 hardens Kevin Brown's PR 71 on the
sprint branch after F-245 and F-249. F-X088 verifies the completed S70 Issue 69
mechanisms and closes the issue with contributor credit and reviewed evidence.
